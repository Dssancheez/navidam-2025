        ...
        <div className="max-w-6xl mx-auto px-4 py-10 text-sm text-white/70">
            <div className="flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <span
                        className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs">#Hackathon</span>
                    <span
                        className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs">#Software</span>
                </div>
            </div>
        </div>
    </footer>
