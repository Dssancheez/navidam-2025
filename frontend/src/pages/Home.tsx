                        ...
                        <div className="grid lg:grid-cols-2 gap-10 items-center">
                            <div className="space-y-5">
                                ...
                                <p className="text-slate-600 text-lg leading-relaxed">
                                    Registra personas, elige una plantilla y una melodía, completa los campos requeridos
                            ...
                            <div className="relative">
                                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span
                                            className="text-xs rounded-full bg-white border border-slate-200 px-3 py-1 text-slate-600">demo</span>
                                    </div>
                                    ...
                                    <div className="mt-4 rounded-2xl bg-white p-6 border border-slate-200">
                                        ...
                                        <p className="mt-3 text-slate-700 leading-relaxed">[Mensaje renderizado por
                                            plantilla]</p>
                                ...
                                <div
                                    className="absolute -top-10 -right-10 h-40 w-40 rounded-full bg-red-500/15 blur-2xl"></div>
                                <div
                                    className="absolute -bottom-10 -left-12 h-44 w-44 rounded-full bg-black/10 blur-2xl"></div>
                            </div>
                        </div>
                    </div>
                </div>
